document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const thinkingIndicator = () =>{
        ...
        const indicatorBody = document.querySelector(".chat-body");
        ...
        setInterval(() => {
            indicatorBody.appendChild(thinkingDots);
    ...
    const handleOutgoingMessage = (message) => {
        ...
        userdiv.classList.add("message-text", "user");
        userdiv.textContent = userData.message;
    ...
    sendButton.addEventListener('click', () =>{
        ...
        if(userMessge){
            handleOutgoingMessage(userMessge);
            messageArea.value = '';
        }
    })
